                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex justify-center">
                                @if($livro->imagem_capa)
                                    <img src="{{ $livro->imagem_capa }}" alt="Capa de {{ $livro->nome }}" class="h-16 rounded shadow-sm" loading="lazy">
                                @else
                        ...
                        @auth
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex justify-center gap-2">
                                    <!-- Botão Editar -->
                                    <a href="{{ route('livros.edit', $livro->id) }}" class="btn btn-sm btn-info gap-1" title="Editar">
